(() => {
    ...
    function initSliders() {
        if (document.querySelector(".actions-slider")) new core(".actions-slider__slider", {
        ...
        if (document.querySelector(".about-us-slider")) new core(".about-us-slider__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
